...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1]   =LAYOUT_all(
		...
		KC_GRV, KVM_1,    KVM_2,    KVM_3,    KVM_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC, KC_INS, KC_NUM, KC_PSLS, KC_PAST, RESET, 
		KC_STAB, KC_Q, KC_W, KC_E, KC_R, KC_T, LAG(KC_B), KC_U, KC_I, KC_O, LSG(KC_S), KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL, KC_P7, KC_P8, KC_P9, KC_PPLS, 
		KC_CAPS, KC_A, LCTL(KC_S), KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT,  KC_P4, KC_P5, KC_P6, 
		...
		KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_LALT,  KC_RCTL, KC_HOME, KC_PGDN, KC_END, KC_P0, KC_PDOT),
};
